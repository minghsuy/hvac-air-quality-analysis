...
- **Sensor precision**: the master-bedroom Airthings rounds PM2.5 to whole numbers (0, 1, 2, ...). Median indoor PM2.5 statistics for case studies use the second-bedroom AirGradient (0.01 µg/m³ precision) unless otherwise noted.
