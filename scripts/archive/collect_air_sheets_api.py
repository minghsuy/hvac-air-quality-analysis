...
class GoogleSheetsWriter:
    ...
    def append_row(self, values):
        ...
        if api_key:
            ...
            url = f"https://sheets.googleapis.com/v4/spreadsheets/{SPREADSHEET_ID}/values/A:Z:append"
            params = {
                'key': api_key,
...
def main():
    ...
    if AIRGRADIENT_INDOOR_SERIAL:
        ...
        if second:
            ...
            print(f"✓ Second bedroom: PM2.5={second['pm25']} μg/m³, Efficiency={second['efficiency']}%")
